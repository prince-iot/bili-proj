...
void DHT_Mode(u8 mode)    // 1:out   0:in
{
...
{	 
 	...
 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
 	GPIO_Init(DHT_PORT, &GPIO_InitStructure);				 //初始化IO口
 	GPIO_SetBits(DHT_PORT,DHT_PIN);						 //PG11 输出高
